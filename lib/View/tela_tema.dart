...
class tela_tema extends StatefulWidget {

  @override
  _tela_temaState createState() => _tela_temaState();
}

class _tela_temaState extends State<tela_tema> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            caixaDeTexto("PERSONALIZE O SEU APLICATIVO", TextAlign.center, tamanhoLetra),
            pularLinha(40),
            caixaDeTexto("Escolha o tema", TextAlign.center, tamanhoLetra), pularLinha(10),
            Row(
            ...
            caixaDeTexto("Escolha a paleta de cores", TextAlign.center, tamanhoLetra), pularLinha(10),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
            ...
            divisao(corPrimaria, 10, 1, 5), pularLinha(10),
            caixaDeTexto("Modo daltonismo", TextAlign.center, tamanhoLetra), pularLinha(10),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
            ...
            divisao(corPrimaria, 10, 1, 5), pularLinha(10),
            caixaDeTexto("Ajustar tamanho de fonte", TextAlign.center, tamanhoLetra), pularLinha(10),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                TextButton(
            ...
            botaoSemBordaSair('Sair', corSecundaria, context, fonte),
          ],
        ),
      ),
    );
